...
<a href="./stats01_excel.php?sel_field=<?=$sel_field?>&fr_date=<?=$fr_date?>&to_date=<?=$to_date?>" class="btn btn_01">엑셀다운</a>
</div>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col">전송시간(센서)</th>
        <th scope="col">송신값(센서)</th>
        <th scope="col">수신시간(DAQ)</th>
        <th scope="col">수신값</th>
        <th scope="col">수신시간(서버)</th>
        <th scope="col">수신값</th>
    </tr>
    </thead>
    <tbody>
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++)
    {
        ...
        <tr class="<?php echo $bg; ?>">
            <td class="td_num"><?php echo $row['vi_code']; ?></td>
            <td class="td_num"><?php echo $row['vi_s_datetime']; ?></td>
            <td class="td_num"><?php echo $row['vi_s_val']; ?></td>
            <td class="td_num"><?php echo $row['vi_d_datetime']; ?></td>
            <td class="td_num"><?php echo $row['vi_d_val']; ?></td>
