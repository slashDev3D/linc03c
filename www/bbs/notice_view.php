...
// 윗글을 얻음
$sql = " select wr_id, wr_subject, wr_datetime from g5_write_notice where wr_is_comment = 0 and wr_num < '{$write['wr_num']}' order by wr_num desc, wr_reply desc limit 1 ";
$prev = sql_fetch($sql);

// 아래글을 얻음
$sql = " select wr_id, wr_subject, wr_datetime from g5_write_notice where wr_is_comment = 0 and wr_num > '{$write['wr_num']}' order by wr_num, wr_reply limit 1 ";
$next = sql_fetch($sql);
...
if (isset($prev['wr_id']) && $prev['wr_id']) {
    ...
    $prev_href = "/bbs/notice.php?wr_id=".$prev['wr_id'];
...
if (isset($next['wr_id']) && $next['wr_id']) {
    ...
    $next_href = "/bbs/notice.php?wr_id=".$next['wr_id'];
    ...
    <div class="member--body">
        <div class="member--body-wrap">
            ...
            <div class="member03--preview-menu">
                ...
                <a href="/bbs/notice.php" class="member03--preview-menuBtn member03--preview-toList">목록</a>
            </div>
