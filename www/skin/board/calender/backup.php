...
<div class="bo_calendar">
    <form>
        ...
        <div class="move_calendar_box">
            <ul class="move_calendar">
                
                <li class="floatL"><a href="<?php echo get_pretty_url($bo_table, '', 'datetime=' . date('Y-m-d', strtotime($thisDate . 'first day of - 1 months'))) ?>">prev</a></li>
                <li class="floatL month"><?php echo ltrim($thisDateArray[0]) . '년 ' . ltrim($thisDateArray[1], '0') . '월' ?></li>
                <li class="floatL"><a href="<?php echo get_pretty_url($bo_table, '', 'datetime=' . date('Y-m-d', strtotime($thisDate . 'first day of + 1 months')))  ?>">next</a></li>
            </ul>
        </div>
        <table class="table">
            <thead>
