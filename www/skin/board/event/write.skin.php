...
<section id="bo_w">
    ...
    <div class="bo_w_info write_div write_div_flex">
        <label for="wr_1" class="sound_only">시작일</label>
	    <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" class="frm_input" size="50" placeholder="시작일">
        <label for="wr_2" class="sound_only">종료일</label>
	    <input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" class="frm_input" size="50" placeholder="종료일">
    </div>
    ...
    <div class=" write_div">
      <label for="wr_3" class="sound_only">메인 배경색</label>
      <input type="text" name="wr_3" value="<?php echo $wr_3 ?>" id="wr_3" class="frm_input half_input" size="50" placeholder="메인 배경색 (#포함)">
    </div>
